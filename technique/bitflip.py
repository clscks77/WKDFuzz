...
def mutate_seq_walking_bits(irp_list, index, func, skip_null=False, effector_map=None, mutation_part="all"):
    ...
    # limit walking bits up to MAX_WALKING_BITS_SIZE. (MAX_WALKING_BITS_SIZE = 0x100)
...
def mutate_seq_two_walking_bits(irp_list, index, func, skip_null=False, effector_map=None, mutation_part="all"):
    if mutation_part == "header":
        original_data = irp_list[index].header
        data = bytearray(original_data)
        InBufferLength = irp_list[index].header_length
...
def mutate_seq_four_walking_bits(irp_list, index, func, skip_null=False, effector_map=None, mutation_part="all"):
    if mutation_part == "header":
        original_data = irp_list[index].header
        data = bytearray(original_data)
        InBufferLength = irp_list[index].header_length
...
def mutate_seq_walking_byte(irp_list, index, func, effector_map=None, limiter_map=None, skip_null=False, mutation_part="all"):
    if mutation_part == "header":
        original_data = irp_list[index].header
        data = bytearray(original_data)
        InBufferLength = irp_list[index].header_length
...
def mutate_seq_two_walking_bytes(irp_list, index, func, effector_map=None, skip_null=False, mutation_part="all"):
    if mutation_part == "header":
        original_data = irp_list[index].header
        data = bytearray(original_data)
        InBufferLength = irp_list[index].header_length
...
def mutate_seq_four_walking_bytes(irp_list, index, func, effector_map=None, skip_null=False, mutation_part="all"):
    if mutation_part == "header":
        original_data = irp_list[index].header
        data = bytearray(original_data)
        InBufferLength = irp_list[index].header_length
