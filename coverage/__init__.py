...
def kafl_workdir_iterator(workdir):
    ...
    # TO DO: Tracing crashes/timeouts has minimal overall improvement ~1-2%
...
def generate_traces(config, nproc, input_list):
    ...
    # TO DO What is the effect of not defining a trace region? will it trace?
    if not config.ip0:
...
def start(settings: LazySettings):
    ...
    # TO DO: store parsed traces here here and share class with other tools
