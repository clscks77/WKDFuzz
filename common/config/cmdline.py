...
def add_args_fuzzer(parser):
    ...
    parser.add_argument('--state-selection-algo', dest='state_selection_algo', required=False, choices=['random', 'round_robin', 'favor'], help='Algorithm for state selection (random, round_robin, favor)') # @@
    parser.add_argument('--seed-selection-algo', dest='seed_selection_algo', required=False, choices=['random', 'round_robin', 'favor'], help='Algorithm for seed selection (random, round_robin, favor)') # @@
    parser.add_argument('--mutation-part', dest='mutation_part', required=False, choices=['all', 'header', 'body'], help='Part of the input to mutate (all, header, body)') # @@
    parser.add_argument('--t-state', dest='target_state_id', required=False, type=int, help='Fixed target state ID for state-aware fuzzing') # @@
    parser.add_argument('--directed', dest='directed', required=False, action='store_true', help="directed mode", default=False) # @@
    parser.add_argument('--log-f', dest='logging_file', required=False, action='store_true', help="logging at file", default=False) # @@
...
class ConfigParserBuilder():
    ...
    def _add_fuzz_subcommand(self, parser: _SubParsersAction): # @@@@@ fuzz
        ...
        fuzz_subcommand.set_defaults(func=fuzz_start) # @@@@@ fuzz
