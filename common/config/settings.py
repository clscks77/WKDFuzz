...
# TO DO: should be used to validate --afl-skip-range
...
settings.validators.register(
    ...
    Validator("state_selection_algo", default="favor_directed", is_in=["random", "round_robin", "favor", "favor_directed"]), # @@
    Validator("seed_selection_algo", default="favor", is_in=["random", "round_robin", "favor"]),  # @@
    Validator("mutation_part", default="all", is_in=["all", "header", "body"]),  # @@
    Validator("target_state_id", default=0, cast=int),  # @@
    Validator("directed", default=False, cast=bool),  # @@
    Validator("logging_file", default=False, cast=bool),  # @@
